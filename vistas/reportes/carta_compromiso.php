...
<style>
 ...
 <div class="content-header">
     <div class="container-fluid">
         <div class="row mb-2">
             <div class="col-sm-6">
                 <h1 class="m-0">Carta Compromiso</h1>
                 
             </div><!-- /.col -->
             <div class="col-sm-6">
                 <ol class="breadcrumb float-sm-right">
                     <li class="breadcrumb-item"><a href="#">Inicio</a></li>
                     <li class="breadcrumb-item active">Carta Compromiso</li>
...
<script> // La búsqueda avanzada lista
     ...
     $(document).ready(function() {   
         tableEx = $("#tbl_expedientes").DataTable({
             ...
             columnDefs: [{
                ...
                {
                    targets: 7, // no muestra el id TELEFONO
                    visible: false
                },
     ...
     function generarPDF(expediente){
       // alert('adentro de generar PDF');
        ...
        $url = '../factura/genera_carta_compromiso.php?expediente=' + expediente;
