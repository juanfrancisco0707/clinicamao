...
?>
 ...
 <div class="content-header">
     <div class="container-fluid">
         <div class="row mb-2">
             <div class="col-sm-6">
                 <h1 class="m-0">Servicios Médicos</h1>
                                                      ...
                                                      $.ajax({
                                                          ...
                                                          success: function(respuesta) {
                                                              ...
                                                              if (respuesta == "ok") {
                                                                   Swal.fire("Este Paciente ya cuenta con un expediente Activo... Verifique!!!");
                                                                 table.ajax.reload();
                                                                 $("#mdlGestionarExpedientesServicios").modal('hide');
                                                             } else {
                                                              $.ajax({
                                                                      async: false,
                                                                      url: "../ajax/expedientes.ajax.php",
                                                                 ...
                                                                 $("#mdlGestionarExpedientesServicios").modal('show');
...
document.getElementById("btnGuardarExpedienteS").addEventListener("click", function() {
               alert("entró al boton de servicio");
               //
