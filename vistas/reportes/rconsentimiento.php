...
<style>
 ...
 <div class="content-header">
     <div class="container-fluid">
         <div class="row mb-2">
             <div class="col-sm-6">
                 <h1 class="m-0">Consentimiento Informado</h1>
...
<script> // La búsqueda avanzada lista
     ...
     function generarPDF(expediente){
       // alert('adentro de generar PDF');
        ...
        $url = '../factura/genera_consentimiento_informado.php?expediente=' + expediente;
