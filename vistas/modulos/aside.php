     ...
     <div class="sidebar">         
         ...
         <nav class="mt-2">
             ...
             <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu"
                 ...
                 <li class="nav-item">
                     <a style="cursor: pointer;" class="nav-link active" id="mdashboard" onclick="CargarContenido('../vistas/dashboard.php','content-wrapper')">
                 ...
                 <li class="nav-item">
                     ...
                     <li class="nav-item">
                         <a style="cursor: pointer;" class="nav-link" id="mrepresentantes" onclick="CargarContenido('../vistas/representantes.php','content-wrapper')">
                                 <i class="fa fa-id-card" aria-hidden="true"></i>&nbsp;&nbsp;
                                 <p>Representantes</p>
                             </a>
                         </li>
                     <li class="nav-item">
                         <a style="cursor: pointer;" class="nav-link" id="mpacientes" onclick="CargarContenido('../vistas/pacientes.php','content-wrapper')">
                                 <i class="fa fa-user-secret" aria-hidden="true"></i>&nbsp;&nbsp;
                                 <p>Pacientes</p>
                             </a>
                         </li>
                         <li class="nav-item">
                         <a style="cursor: pointer;" class="nav-link" id="mexpedientes" onclick="CargarContenido('../vistas/expedientes.php','content-wrapper')">
                         ...
                         <li class="nav-item">
                         <a style="cursor: pointer;" class="nav-link"id="mocupaciones"onclick="CargarContenido('../vistas/ocupaciones.php','content-wrapper')">
                                 <i class="fa fa-briefcase" aria-hidden="true"></i>&nbsp;&nbsp;
                                 <p>Ocupaciones</p>
                             </a>
                         </li>
                         ...
                         <li class="nav-item">
                         <a style="cursor: pointer;" class="nav-link" id="mconceptos" onclick="CargarContenido('../vistas/conceptos.php','content-wrapper')">
                 ...
                 <a href="#" class="nav-link">
                     ...
                     <ul class="nav nav-treeview">
                         <a style="cursor: pointer;" class="nav-link"id="mcapturaingresos" onclick="CargarContenido('../vistas/Ingresos.php','content-wrapper')">
                         <i class="fa fa-credit-card" aria-hidden="true"></i>&nbsp;
                                 <p>
                                   Captura de Ingresos
                                 </p>
                         </a>
                         <a style="cursor: pointer;" class="nav-link" id="madministraingresos" onclick="CargarContenido('../vistas/administra_ingresos.php','content-wrapper')">
                ...
                <li class="nav-item">
                     ...
                     <ul class="nav nav-treeview">
                         ...
                         <li class="nav-item">
                         <a style="cursor: pointer;" class="nav-link"id="mcontrato_internamiento" onclick="CargarContenido('../vistas/reportes/contrato_internamiento.php','content-wrapper')">
                                 <i class="far fa-circle nav-icon"></i>
                                 <p>Contrato de Internamiento</p>
                             </a>
                         </li>
                         <li class="nav-item">
                         <!--<a style="cursor: pointer;" class="nav-link" id="mhoja_ingreso" onclick="CargarContenido('../hoja_ingresoh.php','content-wrapper')">-->
                         <a style="cursor: pointer;" class="nav-link" id="mhoja_ingreso" onclick="CargarContenido('../vistas/reportes/hoja_ingreso_grid.php','content-wrapper')">
                                 <i class="far fa-circle nav-icon"></i>
                                 <p>Hoja de Ingreso</p>
                             </a>
                         </li>
                         <li class="nav-item">
                         <a style="cursor: pointer;" class="nav-link" id="mrconsentimiento" onclick="CargarContenido('../vistas/reportes/rconsentimiento.php','content-wrapper')">
                                 <i class="far fa-circle nav-icon"></i>
                                 <p>Consentimiento Informado</p>
                             </a>
                         </li>
                         <li class="nav-item">
                         <a style="cursor: pointer;" class="nav-link" id="mrconsentimiento_familiar" onclick="CargarContenido('../vistas/reportes/rconsentimiento.php','content-wrapper')">
                                 <i class="far fa-circle nav-icon"></i>
                                 <p>Consentimiento Familiar</p>
                             </a>
                         </li>
                         <li class="nav-item">
                         <a style="cursor: pointer;" class="nav-link" id="mrinformacion_costos" onclick="CargarContenido('../vistas/reportes/informacion_costos.php','content-wrapper')">
                                 <i class="far fa-circle nav-icon"></i>
                                 <p>Información de Costos</p>
                             </a>
                         </li>
                         <li class="nav-item">
                         <a style="cursor: pointer;" class="nav-link" id="mrcarta_compromiso" onclick="CargarContenido('../vistas/reportes/carta_compromiso.php','content-wrapper')">
                                 <i class="far fa-circle nav-icon"></i>
                                 <p>Carta Compromiso</p>
                             </a>
                         </li>
                         <li class="nav-item">
                         <a style="cursor: pointer;" class="nav-link" id="mrregistro_lesiones" onclick="CargarContenido('../vistas/reportes/registro_lesiones.php','content-wrapper')">
                                 <i class="far fa-circle nav-icon"></i>
                                 <p>Registro de lesiones</p>
                             </a>
                         </li>
                         <li class="nav-item">
                         <a style="cursor: pointer;" class="nav-link" id="mrcondiciones_generales_ingreso" onclick="CargarContenido('../vistas/reportes/condiciones_generales_ingreso.php','content-wrapper')">
                                 <i class="far fa-circle nav-icon"></i>
                                 <p>Condiciones Generales de Ingreso</p>
                             </a>
                         </li>
                         <li class="nav-item">
                         <a style="cursor: pointer;" class="nav-link" id="mrnotificacion_mp" onclick="CargarContenido('../vistas/reportes/notificaciones_mp.php','content-wrapper')">
                                 <i class="far fa-circle nav-icon"></i>
                                 <p>Notificación al Ministerio Público</p>
                             </a>
                         </li>
                 ...
                 <li class="nav-item">
                     ...
                     <ul class="nav nav-treeview">
                       <li class="nav-item">
                            <a style="cursor: pointer;" class="nav-link" id="mdashboardo" onclick="CargarContenido('../vistas/dashboard.php','content-wrapper')"><i class="fa fa-cubes" aria-hidden="true"></i>&nbsp;&nbsp;Panel de Control </a>            
                         </li>
