function VerificarUsuario(){
    ...
    //'../controladores/usuario/controlador_verificar_usuario.php',
    $.ajax({
        ...
        if(resp==0){
            ...
            $.ajax({
                url:'controladores/usuario/controlador_crear_session.php',
                type:'POST',
                data:{
                    idusuario:data[0][0],
                    user:data[0][1],
...
function listar_usuario(){
     table = $("#tabla_usuario").DataTable({
       ...
       "processing": true,
       "ajax":{
           "url":"../controladores/usuario/controlador_usuario_listar.php",
           type:'POST'
       },
       "columns":[
           {"data":"posicion"},
...
function Modificar_Estatus(idusuario,estatus){
    ...
    $.ajax({
        "url":"../controladores/usuario/controlador_modificar_estatus_usuario.php",
        type:'POST',
        data:{
            idusuario:idusuario,
            estatus:estatus
...
function listar_combo_rol(){
    $.ajax({
        "url":"../controladores/usuario/controlador_combo_rol_listar.php",
        type:'POST'
    }).done(function(resp){
...
function Registrar_Usuario(){
    ...
    $.ajax({
        "url":"../controladores/usuario/controlador_usuario_registro.php",
        type:'POST',
        data:{
            usuario:usu,
            contrasena:contra,
...
function AbrirModalPerfil(){
    $("#mdlGestionarUsuarios").modal({backdrop:'static',keyboard:false})
