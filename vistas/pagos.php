    ...
    <div class="container-fluid">
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                ...
                <h4 class="m-0">Pagos de Pacientes</h4>
            ...
            <div class="col-md-9">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <h3>Total Pago: S./ <span id="totalPago">0.00</span></h3>
                    </div>
            ...
            <div class="col-md-3">
                ...
                <div class="card shadow">
                    ...
                    <h5 class="card-header py-1 bg-primary text-white text-center">
                        Total Venta: S./ <span id="totalPagoRegistrar">0.00</span>
                    </h5>
...
<script>
    ...
    function recalcularTotales(){
        ...
        table.rows().eq(0).each(function(index) {
            ...
            totalPago = parseFloat(totalPago) + parseFloat(data['total'].replace("S./ ", ""));
        ...
        var totalPago = $("#totalPago").html();
        var igv = parseFloat(totalPago) * 0.18
        var subtotal = parseFloat(totalPago) - parseFloat(igv);
        ...
        $("#boleta_total").html(parseFloat(totalPago).toFixed(2));
    ...
    function realizarVenta(){
        ...
        if (count > 0) {
            ...
            if ($("#iptEfectivoRecibido").val() > 0 && $("#iptEfectivoRecibido").val() != "") {
                ...
                formData.append('total_venta', parseFloat(totalPago));
