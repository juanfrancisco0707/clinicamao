     ...
     <div class="container-fluid">
         <div class="row mb-2">
             <div class="col-sm-6">
                ...
                <input type="hidden" id="Id_Clinicap"/> 
...
$(document).ready(function() {
    ...
    $('#tbl_expedientes tbody').on('click', '.btnImprimirNotificacion', function(){
      ...
      $("#Id_Clinicap").val(data[2]);
      var expediente = $("#Id_Expedientep").val();
      var id_clinica= $("#Id_Clinicap").val();
     
         //alert ('Expediente :' + expediente);
        generarPDF(expediente,id_clinica);
        location.reload();
     /*$.ajax({
    ...
    function generarPDF(expediente,id_clinica){
       ...
       // alert("antes de la url");
        $url = '../factura/generanotificacion_mp.php?expediente='+expediente+"&id_clinica="+id_clinica;
       // alert("despues de la url :"+ $url);
