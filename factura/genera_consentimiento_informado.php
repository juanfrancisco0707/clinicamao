...
if(!isset($_SESSION['S_IDUSUARIO'])){
	...
	{
		echo "No es posible generar el reporte de Consentimiento Informado";
	}else{
		...
		if($nr > 0){
			...
			ob_start();
		    include(dirname('__FILE__').'/consentimiento_informado_plantilla.php');
		    $html = ob_get_clean();
			...
			$dompdf->stream('consentimiento_informado_'.$expediente.'.pdf',array('Attachment'=>0));
			exit;
			}
		}	
	}
