            ...
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu"
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a style="cursor: pointer;" class="nav-link" id="mcontrato_internamiento"
                                onclick="CargarContenido('../vistas/reportes/contrato_internamiento.php','content-wrapper')">
                        ...
                        <li class="nav-item">
                            ...
                            <a style="cursor: pointer;" class="nav-link" id="mhoja_ingreso"
                                onclick="CargarContenido('../vistas/reportes/hoja_ingreso_grid.php','content-wrapper')">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Hoja de Ingreso</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a style="cursor: pointer;" class="nav-link" id="mrconsentimiento"
                                onclick="CargarContenido('../vistas/reportes/rconsentimiento.php','content-wrapper')">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Consentimiento Informado</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a style="cursor: pointer;" class="nav-link" id="mrconsentimiento_familiar"
                                onclick="CargarContenido('../vistas/reportes/rconsentimiento.php','content-wrapper')">
                                <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item">
                            <a style="cursor: pointer;" class="nav-link" id="mrinformacion_costos"
                                onclick="CargarContenido('../vistas/reportes/informacion_costos.php','content-wrapper')">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Información de Costos</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a style="cursor: pointer;" class="nav-link" id="mrcarta_compromiso"
                                onclick="CargarContenido('../vistas/reportes/carta_compromiso.php','content-wrapper')">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Carta Compromiso</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a style="cursor: pointer;" class="nav-link" id="mrregistro_lesiones"
                                onclick="CargarContenido('../vistas/reportes/registro_lesiones.php','content-wrapper')">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Registro de lesiones</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a style="cursor: pointer;" class="nav-link" id="mrcondiciones_generales_ingreso"
                                onclick="CargarContenido('../vistas/reportes/condiciones_generales_ingreso.php','content-wrapper')">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Condiciones Generales de Ingreso</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a style="cursor: pointer;" class="nav-link" id="mrnotificacion_mp"
                                onclick="CargarContenido('../vistas/reportes/notificaciones_mp.php','content-wrapper')">
                                <i class="far fa-circle nav-icon"></i>
